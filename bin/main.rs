...
use scaffolding_application::use_cases::{
    ...
    create_domain_port_with_implementation::CreateDomainPortWithImplementation,
...
impl CompositionRoot {
    fn new() -> Self {
        ...
        Self {
            ...
            create_domain_port_artifact: CreateDomainPortWithImplementation::new(artifact_scaffolder.clone(), artifact_scaffolder.clone()),
...
fn main() {
    ...
    let app = App::new(
        ...
        composition_root.create_domain_port_artifact,
